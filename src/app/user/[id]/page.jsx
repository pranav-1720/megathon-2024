...
export default function User({ params }) {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column" }}>
      <SideBarComponent />
      <div className="flex flex-col leading-10 items-center justify-center m-3">
        <div className="gap-1.5 w-full max-w-lg">
          <Label htmlFor="message" className="font-bold text-lg ml-2 mb-2">Today's Thoughts</Label>
          <div className="flex flex-row">
            <Input type="email" id="message" placeholder="I am feeling..." />
            <button className="ml-2 mt-1 w-0 h-0 
              border-t-[1em] border-t-transparent
              border-l-[1em] border-l-black
              border-b-[1em] border-b-transparent"></button>
          </div>
        </div>

        <div className="mt-6" id="History">
          <Label htmlFor="History" className="font-bold text-lg ml-2">History</Label>
          {placeholder.entries.slice().reverse().map((entry) => (
            <Card className={clsx(
              "hover:scale-[1.02] max-w-lg p-3 mb-4 leading-5",
              ...
              <CardContent className="flex flex-col">
                ...
                <div className="flex">
                  ...
                  <Button className="block w-min h-min leading-[1.1] mt-1.5 ml-auto pl-2 pr-2">
        ...
        <div className="w-full mt-6">
          <div className="w-3/5  h-32 bg-brown-800 rounded-xl border-8 border-brown-900 mx-auto"></div>
          <div className="w-2/5  h-32 bg-brown-800 rounded-xl border-8 border-t-0 rounded-t-none border-brown-900 mx-auto"></div>
        </div>
      </div>
    </Box>
